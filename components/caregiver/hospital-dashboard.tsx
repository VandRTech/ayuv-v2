    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">Centralized patient monitoring and early warning system</p>
        </div>
      ...
      <Tabs defaultValue="monitoring" className="space-y-6">
        <TabsList className="bg-slate-800 border-slate-700">
          ...
          <TabsTrigger value="ews" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
                ...
                >
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={getSeverityColor(patient.severity)}>{patient.severity.toUpperCase()}</Badge>
                    </div>
                  </CardHeader>
                    ...
                    .map((patient) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <p className="text-red-400 font-bold text-lg">NEWS: {patient.newsScore}</p>
                          <p className="text-slate-400 text-sm">{patient.lastUpdate}</p>
                        </div>
                      </div>
                    ))}
                </div>
        ...
        <TabsContent value="accuracy" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-slate-900/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Aegis Device Status</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {hospitalPatients.map((patient) => (
                  <div key={patient.id} className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
                    <div>
                      <p className="text-white font-medium">{patient.deviceId}</p>
                      <p className="text-slate-400 text-sm">
            ...
            <Card className="bg-slate-900/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Monitoring Accuracy</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Heart Rate Accuracy</span>
                    <span className="text-green-400 font-medium">99.2%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">SpO2 Accuracy</span>
                    <span className="text-green-400 font-medium">98.7%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Temperature Accuracy</span>
                    <span className="text-green-400 font-medium">99.5%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-400">Motion Artifact Reduction</span>
                    <span className="text-green-400 font-medium">95.3%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-slate-900/50 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white">Historical Vital Signs</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-64 flex items-center justify-center text-slate-400">
