    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">Multi-generation health tracking and management</p>
        </div>
            ...
            <Card className="bg-slate-900/50 border-slate-700">
              ...
              <CardContent className="space-y-3">
                {selectedMember.medications.length > 0 ? (
                  ...
                  <p className="text-slate-400 text-center py-4">No medications recorded</p>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                {selectedMember.vaccinations.map((vaccination) => (
                  <div key={vaccination.id} className="p-3 bg-slate-800/50 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-white font-medium">{vaccination.vaccine}</h4>
                      <Badge variant="outline" className="text-green-400 border-green-500/30">
                        Complete
                      </Badge>
                    </div>
                    <p className="text-slate-400 text-sm">Given: {vaccination.date}</p>
              ...
              <CardContent className="space-y-4">
                <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-400 font-medium">All Systems Normal</span>
                  </div>
                  <p className="text-slate-400 text-sm mt-1">Emergency detection active for all family members</p>
                </div>

                <div className="space-y-2">
                  <h4 className="text-white font-medium">Emergency Features:</h4>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <p className="text-slate-400 text-sm">Home • 2 min ago</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-1">
