...
import { Mail, Lock, User, Calendar, Phone, Briefcase, HeartPulse, Rocket, Loader2, RefreshCw } from "lucide-react"
...
// Update the shared class for all form fields for a minimal, modern look
              ...
              {!isLogin && (
                <>
                  ...
                  <div className="flex items-center gap-4 bg-gray-900/50 p-3 rounded-lg">
                    <p className="text-white">What is {num1} + {num2}?</p>
                    <StaticInput icon={User} label="Answer" type="number" value={captchaAnswer} onChange={(e) => setCaptchaAnswer(e.target.value)} required />
                    <button onClick={generateCaptcha} className="p-2 text-gray-400 hover:text-white">
